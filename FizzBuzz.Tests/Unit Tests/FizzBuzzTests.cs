...
namespace FizzBuzz.Tests.Unit_Tests
{
    ...
    public class FizzBuzzTests
    {
        ...
        [Test]
        public void FizzBuzz_ToTwenty_ListIsCorrect()
        {
            var expected = new List<string> { "1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz", "11", "Fizz", "13", "14", "FizzBuzz", "16", "17", "Fizz", "19", "Buzz" };
            var actual = FizzBuzz.To(20);
            Assert.AreEqual(expected, actual);
        }
    }
}
